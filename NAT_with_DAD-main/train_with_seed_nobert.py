...
--dropout 0.1 --max-source-positions 200 --max-target-positions 200 --max-update 300000 --seed <SEED>
--clip-norm 5 --encoder-layers 6 --encoder-embed-dim 512 --decoder-layers 6 --decoder-embed-dim 512 
--fp16 --activation-fn gelu --user-dir dad_plugins --src-embedding-copy 
...
--save-dir /data/yl7622/NAT-with-Ernie-M/NAT_with_DAD-main/save_seed/<NAME>

--reset-optimizer --patience 15'''.replace("<DATASET>", args["dataset"]).replace("<SEED>", str(seed)).replace("<NAME>", checkpoint_dir)
...
python3 fairseq_cli/generate.py <DATASET> 
	--path /data/yl7622/NAT-with-Ernie-M/NAT_with_DAD-main/save_seed/<CHECKPOINT_DIR>/checkpoint_best.pt --user-dir dad_plugins 
    ...
    /data/yl7622/NAT-with-Ernie-M/NAT_with_DAD-main/generation_save_seed/<CHECKPOINT_DIR>
