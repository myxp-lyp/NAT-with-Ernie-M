...
--adam-eps 1e-6 --lr-scheduler inverse_sqrt --lr 3e-4 --warmup-updates 4000 --max-tokens 2048 
--dropout 0.1 --max-source-positions 512 --max-target-positions 512 --max-update 30000000 --seed <SEED>
...
--CAMLMload /data/yl7622/NAT-with-Ernie-M/NAT_with_DAD-main/save_new/CAMLM_lbpe_wmt/checkpoint_best.pt 
